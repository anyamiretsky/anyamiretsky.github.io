...
$(document).ready(function () {
    ...
    $('#entry').submit(function(event){
        ...
        let entryVal = parseInt($('#newEntry').val());
        
        //add new row to table
        $('#entries').append('<tr><td></td><td >$'+entryVal+'</td></tr>');
        $('#newEntry').val('');
        $('#newEntry').focus();
       
        total = total + entryVal;
...
//press enter and total will submit
//clear out previous value and focus on input